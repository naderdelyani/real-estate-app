          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                { icon: Bath,      value: `${property.bathrooms} Baths` },
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl shadow-card p-6 sticky top-6">
              ...
              <p className="mt-4 text-xs text-center text-gray-400">
                Listed on {new Date(property.createdAt).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}
              </p>
            </div>
          </div>
        </div>
